 ...
 *         Luigi Pannocchi <l.pannocchi@gmail.com>
 * @date 2018-02-04
 */
...
int main(int argc, char **argv)
{
	...
	if (argc == 3) {
		...
		std::cout << "Assuming mission already loaded." << std::endl;

	while (action->arm() != ActionResult::SUCCESS) {
		sleep_for(seconds(2));
	...
	whttps://stackoverflow.com/questions/1716296/why-does-printf-not-flush-after-the-call-unless-a-newline-is-in-the-format-strinhile (!mission->mission_finished()) {
		sleep_for(seconds(1));
	}
